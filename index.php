...
<!-- Matric Section -->
<section class="matric-section">
    <div class="matric-container">
        <img src="matric1.jpeg" alt="Matric Celebration" class="matric-image">
        <div class="matric-text">
            <h2>🎓Matric Celebration Glam🎓</h2>
            <p>Get your special night with our Matric Dance beauty and packages. Let us make you shine brighter than ever!</p>
            
        </div>
    </div>

    <!-- Two responsive windows with images -->
    <div class="matric-gallery">
        <div class="matric-box">
            <img src="matric2.jpeg" alt="Matric Look 1">
            <a href="https://wa.me/yourwhatsapplink" class="whatsapp-btn" target="_blank">
                <i class="fab fa-whatsapp"></i> Book Now
            </a>
        </div>
        <div class="matric-box">
            <img src="matric3.jpeg" alt="Matric Look 2">
            <a href="https://wa.me/yourwhatsapplink" class="whatsapp-btn" target="_blank">
                <i class="fab fa-whatsapp"></i> Book Now
            </a>
        </div>
...
<style>
.matric-section {
    background: linear-gradient(to bottom, #8b0000, black);
    padding: 60px 20px;
    text-align: center;
    color: white;
}
